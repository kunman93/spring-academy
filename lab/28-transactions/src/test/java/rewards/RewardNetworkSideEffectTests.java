 ...
 * <p>
 * `@Transactional` needs to be added at class level, because the changes made by the first test were rolled back.
...
public class RewardNetworkSideEffectTests {
    ...
    private void runTest() {
        ...
        assertEquals(
            Double.valueOf(annabelleInitialSavings + 4.00d),
            jdbcTemplate.queryForObject(SAVINGS_SQL, Double.class, "Annabelle")
        );
        assertEquals(
            Double.valueOf(corganInitialSavings + 4.00d),
