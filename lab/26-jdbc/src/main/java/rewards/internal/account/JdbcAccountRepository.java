...
public class JdbcAccountRepository implements AccountRepository {
    ...
    public Account findByCreditCard(String creditCardNumber) {
        ...
        /* Sometimes when doing complex joins in a query you’ll need to have access to an entire result set instead of just a single row of a result set to build a domain object.
         * To do this you’ll need to tell the JdbcTemplate that you would like to have a full control over ResultSet extraction.
         */
