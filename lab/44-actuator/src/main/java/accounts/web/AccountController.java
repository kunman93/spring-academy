...
public class AccountController {
     ...
     */
    /* custom actuator timer metric "account.timer" which can be accessed through: http://localhost:8080/actuator/metrics/account.timer
     * The endpoint can only be accessed when this method or any other method with @Timer annotation is called at least once.
     */
